...
(__sub__()), умножение (__mul__()), деление (__floordiv____truediv__()). Эти методы должны применяться только к клеткам
...
class Cell:
    ...
    def __sub__(self, other):
        return self.nums - other.nums if self.nums - other.nums > 0 \
            else 'Ячееек в первой клеткеменьше или равно второй вычитаний невозможно'
